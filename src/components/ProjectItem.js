...
export const ProjectItem = (props) => {
    return (
        <a href={props.info.link} className="transition-transform drop-shadow-sm hover:text-orange border border-gray-900 project min-[400px]:w-96 sm:w-full relative" target="_blank" rel="noreferrer">
