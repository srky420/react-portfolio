...
export const Work = () => {
    ...
    return (
        <div className="bg-brown text-light py-5 show min-h-screen relative" id="work">
            <div className="container mx-auto px-3 h-full lg:px-20 2xl:px-40 relative mb-20">
