            ...
            <div className="container mx-auto sm:px-5 lg:px-20 2xl:px-40 flex items-center justify-center md:justify-between h-full">
                <div className="flex flex-col items-center text-center md:items-start gap-y-5 lg:gap-y-10">
                    ...
                    <div className="flex gap-4 my-3 mx-auto md:mx-0">
                        <button className="py-2 px-4 sm:py-3 text-sm lg:text-lg bg-transparent border border-gray-200 hover:bg-brown hover:border-brown transition-colors">See Projects</button>
                        <button className="py-2 px-4 sm:py-3 text-sm lg:text-lg bg-transparent border border-gray-200 hover:bg-brown hover:border-brown transition-colors">Contact Me</button>
                    </div>
                </div>
